...
if ($ARGV[0]){
&Getopt::Std::getopts('v:j:u:p:s:H:h:e:n:N:o:i:P:gr', \%opt) || die ;
}else{
&help_text; 
}
...
sub split_by_biotype{
    ...
    my $prots = "'protein_coding_$feat_name', 'V_segment_$feat_name', 'C_segment_$feat_name', 'J_segment_$feat_name', 'D_segment_$feat_name'";
