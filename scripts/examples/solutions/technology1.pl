...
print "Question 1: Fetch the Sanger ENCODE3.1.1 array. Print out it's name, type, description and vendor. Hint: use the ArrayAdaptor->fetch by_name method.\n";


#Grab the array using the array adaptor
my $encode_array = $array_adaptor->fetch_by_name_vendor('ENCODE3.1.1', 'SANGER');

#Print out attributes
print "Array name:\t"  .$encode_array->name.
  "\nArray type\t".$encode_array->type.
  "\nArray vendor\t".$encode_array->vendor.
  "\nArray description\t".$encode_array->description."\n";
