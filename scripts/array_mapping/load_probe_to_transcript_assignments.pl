...
GetOptions (
   ...
   'probeset_transcript_assignments_file' => \$probeset_transcript_assignments_file,
   'probeset_transcript_rejections_file'  => \$probeset_transcript_rejections_file,
   'probe_transcript_assignments_file'    => \$probe_transcript_assignments_file,
);
