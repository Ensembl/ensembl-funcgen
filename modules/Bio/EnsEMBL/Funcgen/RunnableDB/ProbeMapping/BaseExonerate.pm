...
Bio::EnsEMBL::Funcgen::RunnableDB::ProbeMapping
...
package Bio::EnsEMBL::Funcgen::RunnableDB::ProbeMapping::BaseExonerate;
...
sub run {
  ...
  #$command .= " | head ";  
  #$command = "head /nfs/users/nfs_m/mn1/test_exonerate_output.txt ";
