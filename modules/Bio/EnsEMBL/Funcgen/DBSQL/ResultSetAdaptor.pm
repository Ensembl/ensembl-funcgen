...
@ISA = qw(Bio::EnsEMBL::Funcgen::DBSQL::ResultSetAdaptor);

#or generates a ResultSet which contains info about ResultSet content
#and actual results for channel or for whole chip...contig sets?
#plus feature_sets

#This is to replace calls in OligoFeature adaptor
