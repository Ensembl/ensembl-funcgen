...
=head2 list_dbIDs
  ...
  Args       : None
  Example    : my @group_ids = @{$eg_adaptor->list_dbIDs()};
  Description: Gets an array of internal IDs for all ExperimentalGroup objects in the
               current database.
...
sub list_dbIDs {
    ...
    return $self->_list_dbIDs('experimental_group');
}
