...
#     my $epigenome_tracks = $self->fetch_all_by_Epigenome($epigenome);
    
#     my @result;
#     foreach my $epigenome_track (@$epigenome_tracks) {
    
#       my $experiment = $epigenome_track->get_Experiment;
#       my $experimental_group = $experiment->experimental_group;
      
#       if ($experimental_group->name eq $experimental_group_wanted->name) {
#         push @result, $epigenome_track;
#       }
...
# sub fetch_by_EpigenomeTrackStatistic {
#     my $self                   = shift;
#     my $epigenome_track_statistic = shift;
#     return $self->fetch_by_dbID($epigenome_track_statistic->epigenome_track_id);
# }

# sub count_peaks_by_EpigenomeTrack {
#   my $self = shift;
#   my $epigenome_track = shift;
#   return $self->db->get_PeakAdaptor->count_all('epigenome_track_id = ' . $epigenome_track->dbID);
# }
