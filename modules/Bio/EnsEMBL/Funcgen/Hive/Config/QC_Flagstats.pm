...
#         },
	{
	    ...
	    -flow_into => {
		'3'   => [  'QcFlagstatsJobFactory' ],
		'4'   => [  'QcFlagstatsJobFactory' ],
		'5'   => [  'QcFlagstatsJobFactory' ],
		'6'   => [  'QcFlagstatsJobFactory' ],
		'100' => [  'QcFlagstatsJobFactory' ],
	    },
	},
...
# samtools flagstat /lustre/scratch109/ensembl/funcgen/mn1/ersa/faang/alignments/homo_sapiens/GRCh38/3526/K562:hist:BR2_H3K27ac_3526_bwa_samse_3.bam
            },
            -flow_into => { 
	      '1' => [ 'LoadFlagstatsToDB' ],
            },
