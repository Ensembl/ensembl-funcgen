...
sub pipeline_analyses {
    ...
    return [
      {   -logic_name => 'start_segmentation',
          ...
          -flow_into => { 
            'MAIN->A' => 'segmentation_job_factory',
      ...
      {   -logic_name => 'segmentation_job_factory',
          ...
          -flow_into => {
            '2->A' => 'make_celltable_dir',
            'A->2' => 'generate_segmentation_parameter_file',
          },
      },
      
      {   -logic_name => 'make_celltable_dir',
          -module     => 'Bio::EnsEMBL::Hive::RunnableDB::SystemCmd',
          -parameters => {
              cmd => qq(mkdir -p #tempdir_segmentation#/#species#/celltables),
          },
          -flow_into => { 
            MAIN     => 'for_every_epigenome',
          },
      },
      {   -logic_name  => 'for_every_epigenome',
          -module     => 'Bio::EnsEMBL::Hive::RunnableDB::JobFactory',
          -parameters => {
              db_conn    => 'funcgen:#species#',
              inputquery => 'select name as epigenome, production_name as epigenome_production_name from epigenome',
          },
          -flow_into => {
              2 => { 'generate_cell_table_file' => INPUT_PLUS },
          },
      },
      ...
      {   -logic_name => 'generate_cell_table_file',
          ...
          -parameters => {
            cmd => qq( generate_cell_table_file.pl      )
              ...
              . qq( --cell_table_file #tempdir_segmentation#/#species#/celltables/#epigenome_production_name#.txt )
              . qq( --epigenome       #epigenome#       )
              
          },
          -flow_into => { 
            MAIN     => { 'binarize' => INPUT_PLUS },
          },
      },
      {   -logic_name => 'binarize',
          -module     => 'Bio::EnsEMBL::Hive::RunnableDB::SystemCmd',
          ...
          -parameters => { 
            cmd => qq(java -Xmx14500M )
              ...
              . qq( #tempdir_segmentation#/#species#/celltables/#epigenome_production_name#.txt )
...
sub resource_classes {
    ...
    return {
         ...
         'binarization' => {'LSF' => '-M16000 -R"select[mem>16000] rusage[mem=16000]" -n 20'               },
