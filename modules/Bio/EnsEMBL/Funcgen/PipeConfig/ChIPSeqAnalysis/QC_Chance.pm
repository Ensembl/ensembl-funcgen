...
=head1 NAME
    ...
    Bio::EnsEMBL::Funcgen::PipeConfig::ChIPSeqAnalysis::QC_Chance
...
package Bio::EnsEMBL::Funcgen::PipeConfig::ChIPSeqAnalysis::QC_Chance;
...
sub pipeline_analyses {
    ...
    return [
        ...
        },
        {
          ...
          -module        => 'Bio::EnsEMBL::Funcgen::RunnableDB::ChIPSeq::QcChanceJobFactory',
          -flow_into => { 
              2 => [
