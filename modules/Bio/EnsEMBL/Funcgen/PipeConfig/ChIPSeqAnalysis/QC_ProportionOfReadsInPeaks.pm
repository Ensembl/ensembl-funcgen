...
=head1 NAME
    ...
    Bio::EnsEMBL::Funcgen::PipeConfig::ChIPSeqAnalysis::QC_ProportionOfReadsInPeaks
...
=cut
package Bio::EnsEMBL::Funcgen::PipeConfig::ChIPSeqAnalysis::QC_ProportionOfReadsInPeaks;
    ...
    return [
      {
          ...
          -flow_into => { 
            1 => 'seed_all_peak_callings_from_experiment',
          },
      },
      {
          -logic_name  => 'seed_all_peak_callings_from_experiment',
          -module     => 'Bio::EnsEMBL::Funcgen::RunnableDB::ChIPSeq::SeedAllPeakCallingsFromExperiment',
          -flow_into => { 
