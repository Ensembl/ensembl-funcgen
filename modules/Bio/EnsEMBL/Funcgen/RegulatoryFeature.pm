...
=head1 SYNOPSIS
 ...
 my $feature = Bio::EnsEMBL::Funcgen::RegulatoryFeature->new(
    ...
    #-_ATTRIBUTE_CACHE => \%attr_cache, # Can optionally set cache directly for speed
 ); 
...
sub display_label {
	...
	#need to remove this...altho' unlikely we will ever call more than once?



	my $display_label = $self->feature_type->name()." Regulatory Feature";
	$display_label .= " - ".$self->cell_type->name() if defined $self->cell_type();
