#
# EnsEMBL module for Bio::EnsEMBL::Funcgen::Parsers::Solexa
#

=head1 NAME

Bio::EnsEMBL::Funcgen::Parsers::Solexa

=head1 SYNOPSIS

  my $parser_type = "Bio::EnsEMBL::Funcgen::Parsers::Solexa";
...
normally set by the Importer as the parent class.  Solexa contains meta 
...
package Bio::EnsEMBL::Funcgen::Parsers::Solexa;
...
=head2 new
  ...
  Description: Constructor method for Solexa class
  Returntype : Bio::EnsEMBL::Funcgen::Parsers::Solexa
...
sub read_and_import_bed_data{
  ...
  if (scalar(@{$self->result_files()}) >1) {
	throw("Found more than one cluster file:\n".
		  join("\n", @{$self->result_files()})."\nSolexa does not yet handle replicates\n".
