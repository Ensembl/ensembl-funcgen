...
#skip these tests
SKIP_TESTS="--skip MultiTestDB.t,FeatureSet.t,CoordSystem.t,Array_ArrayChip.t,
Storable.t,RegulatoryFeature.t,InputSet_Set_BaseAdaptor.t,Channel.t,BaseFeatureAdaptor.t,BindingMatrix_MotifFeature.t,Annotated_SetFeatureAdaptor.t,DNAMethylationFeature.t"
