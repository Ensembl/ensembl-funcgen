...
SKIP_TESTS="--skip Annotated_SetFeatureAdaptor.t,BaseFeatureAdaptor.t,BindingMatrix_MotifFeature.t,CoordSystem.t,FeatureSet.t,FeatureType.t,InputSet_Set_BaseAdaptor.t,MultiTestDB.t,RegulatoryFeature.t,ResultFeature.t,ResultSet.t,Storable.t"
