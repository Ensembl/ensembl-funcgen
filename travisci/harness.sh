...
#export PERL5LIB=$PWD/bioperl-live-bioperl-release-1-2-3:$PWD/ensembl/modules:$PWD/ensembl-test/modules:$PWD/ensembl-funcgen/modules:/nfs/users/nfs_m/mn1/perl5/lib/perl5/
...
if [ "$COVERALLS" = 'true' ]; then
  ...
  perl $PWD/ensembl-test/scripts/runtests.pl $PWD/ensembl-funcgen/modules/t/ $SKIP_TESTS
fi
